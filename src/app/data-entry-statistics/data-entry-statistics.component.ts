...
export class DataEntryStatisticsComponent
  ...
  public ngOnInit() {
    console.log('Loaded Entry stats');
  }
  ...
  public selectedFilterParams($event) {
    ...
    console.log('Filter Params', $event);
  ...
  public resetFilter($event) {
    console.log('Reset Filter', $event);
    this.resetAllStats();
  }
...
public showPatientListData() {
  ...
  console.log('showPatientListData()');
