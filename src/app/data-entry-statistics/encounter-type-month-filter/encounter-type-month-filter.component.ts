...
@Component({
  selector: 'encounter-month-filter',
  templateUrl: './encounter-type-month-filter.component.html'
})
export class EncounterTypeMonthFilterComponent implements OnInit, OnDestroy , AfterViewInit {
  ...
  public selectedStartMonth: string = Moment().format('DD-MMM-YYYY');
