...
export class DailyScheduleAppointmentsComponent implements OnInit, OnDestroy {
  ...
  private filterSelected() {
      ...
      if (typeof programVisitCookie === 'undefined') {
           ...
           this.localStorageService.setItem(cookieKey, cookieVal);
      ...
      console.log('Daily Appointments Cookie val', cookieVal);

      this.encodedParams = cookieVal;

      console.log('Daily Appointments Cookie PARAMS', this.encodedParams);
