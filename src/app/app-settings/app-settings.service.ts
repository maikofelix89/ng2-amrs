...
export class AppSettingsService {
  ...
  public static readonly DEFAULT_AMRSIDGEN_SERVER_URL = 'https://ngx.ampath.or.ke/amrs-id-generator';
  ...
  public static readonly AMRSIDGEN_SERVER_LIST_KEY = 'appSettings.amrsIdGenServerList';
  ...
  constructor(private localStorageService: LocalStorageService) {
    ...
    console.log('cachedEtlUrls', cachedEtlUrls);
    if (cachedEtlUrls) {
    ...
    console.log('cachedEtlUrl', cachedEtlUrl);
    if (cachedEtlUrl) {
    ...
    const cachedAmrsIdGenUrls = localStorageService.getItem(AppSettingsService.AMRSIDGEN_SERVER_LIST_KEY);
    console.log('cachedAmrsIdGenUrls', cachedAmrsIdGenUrls);
    if (cachedAmrsIdGenUrls) {
      this._amrsIdGenServerUrls = JSON.parse(cachedAmrsIdGenUrls);
    } else {
      console.log('set');
      localStorageService.setItem(AppSettingsService.AMRSIDGEN_SERVER_LIST_KEY,
        JSON.stringify(this.amrsIdGenServerUrls));
    }

    const cachedAmrsIdGenUrl = localStorageService.getItem(AppSettingsService.DEFAULT_AMRSIDGEN_SERVER_URL);
  ...
  public setAmrsIdGenServer(value: string): void {
    ...
    this.localStorageService.setItem(AppSettingsService.AMRSIDGEN_SERVER_KEY, value);
    this._amrsIdGenServer = value;
  }

  public getAmrsIdGenServer(): string {
    return this.localStorageService.getItem(AppSettingsService.AMRSIDGEN_SERVER_KEY) || this._amrsIdGenServer;
  }
