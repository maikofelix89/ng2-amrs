...
export class FormentryComponent implements OnInit, OnDestroy {
  ...
  public trackSumissionArray: any = [];
  ...
  private submitForm(payloadTypes: Array<string> = ['encounter', 'personAttribute']): void {
    ...
    if (submittedStatus === true) {
        ...
        this.trackSumissionArray.push('1');
 ...
 private checkFormSumittedStatus() {
     ...
     let submitStatusLength = this.trackSumissionArray.length;


     if (submitStatusLength > 0 ) {
         return true;
     } else {
         return false;
     }
 ...
 private resetSubmitTrackArray() {

   this.trackSumissionArray = [];
